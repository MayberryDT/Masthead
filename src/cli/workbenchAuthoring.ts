...
export function workbenchHelp(): string {
  return [
    ...
    "",
    "  Stop only when nextAction.kind is \"complete\", a request receipt exists, AND every pack is finished.",
    "  Pack finish is not request completion (1 pack or 6 packs is still NOT DONE). Prefer: workbench author status --request <id> --json",
    "",
