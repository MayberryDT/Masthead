...
export type MastheadPagesDesktopClient = {
  readonly browserReviewOnly?: true;
  ...
  createPublicLogbook(
    input: CreatePublicLogbookRequestV1,
  ): Promise<PublicLogbookSummaryV1>;
...
export function createMastheadPagesDesktopClient(): MastheadPagesDesktopClient {
  return {
    getConnection: async () => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:getMastheadPagesConnection",
        );
      return method();
    },
    connect: async () => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:connectMastheadPages",
        );
      return method();
    },
    disconnect: async () => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:disconnectMastheadPages",
        );
      await method();
    },
    listPublicLogbooks: async () => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:listMastheadPagesLogbooks",
        );
    ...
    createPublicLogbook: async (input) => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:createMastheadPagesLogbook",
        );
    ...
    chooseCover: async () => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:chooseMastheadPagesCover",
        );
      return method() as Promise<
    ...
    clearCover: async (selectionId) => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:clearMastheadPagesCover",
        );
    ...
    uploadCover: async (input) => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:uploadMastheadPagesCover",
        );
    ...
    publishStaged: async (refs) => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:publishStagedToMastheadPages",
        );
    ...
    withdrawStaged: async (ref) => {
      ...
      if (!method)
        throw new Error(
          "masthead_pages_bridge_unavailable:removeStagedFromMastheadPages",
        );
