...
export type SessionDossierContentProps = {
...
/** The original human-readable dossier presentation and transcript observer. */
export function SessionDossierContent({
  compactShell = false,
  dossier,
