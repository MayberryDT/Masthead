...
const SUPPORTED_RUNTIMES = ["codex", "cursor", "claude_code", "opencode", "grok", "hermes", "pi", "omp"] as const;
...
describe("adapter registry", () => {
  ...
  test("uses catalog scan targets for required scan adapters, including importable Codex", () => {
    const scanRuntimes = SUPPORTED_RUNTIMES;
