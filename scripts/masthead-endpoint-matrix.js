...
export const READ_ONLY_ENDPOINTS = [
  ...
  { method: "GET", path: "/sources/connectors", label: "harness connectors snapshot" },
  ...
  { method: "GET", path: "/workbench/sessions?limit=10", label: "workbench pipeline queue" },
...
export const BLOCKED_MUTATION_ENDPOINTS = [
  { method: "POST", path: "/mcp/test-connection", label: "mcp connection test" },
  { method: "POST", path: "/mcp/launch-config/validate", label: "mcp launch validation" },
  { method: "POST", path: "/settings/llm-provider/models", label: "llm provider model discovery" },
  ...
  { method: "POST", path: "/sources/connectors/discover", label: "discover harness connectors" },
  { method: "POST", path: "/sources/connectors/codex/enable", label: "enable harness connector" },
  { method: "POST", path: "/sources/connectors/codex/test", label: "test harness connector" },
  { method: "POST", path: "/sources/connectors/codex/uninstall", label: "uninstall harness connector" },
  { method: "POST", path: "/sources/connectors/codex/confirm-activation", label: "confirm harness connector activation" },
