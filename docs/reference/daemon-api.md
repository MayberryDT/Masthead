...
- `POST /workbench/sessions/:sessionId/publish` advances the legacy per-session package-path operation. Agent-led enrichment and artifact authoring use the explicit routes below.
