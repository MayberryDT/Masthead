...
- Multi-adapter Sources registry, bounded scan service, connect-selected workflow, and conservative local import attempts for Codex, Cursor, Claude Code, OpenCode, Aider, OpenClaw, Hermes, Pi, and OMP.
