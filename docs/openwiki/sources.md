...
**Contract (source of truth):** [docs/reference/sources-v2.md](../reference/sources-v2.md)  
**Decision:** [ADR 0010](../adr/0010-sources-v2-live-connect-only.md)
...
Product contract remains [sources-v2.md](../reference/sources-v2.md). Route reference: [daemon-api.md](../reference/daemon-api.md).
