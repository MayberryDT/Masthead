...
[`workbench-authoring-v5-migration.md`](../reference/workbench-authoring-v5-migration.md).
...
- **Logbook** is a collection of **Pages**: capsule list + body inspector + provenance. Capsules remain artifacts internally. Always-visible Page checkboxes and current-page table-header **Select all** feed optional Masthead Pages batch review; the compact **Publish** button is disabled until a Page is selected. There is no bulk enrich or session-library chrome.
...
Vocabulary and cutover: `docs/internal/CONTEXT.md`, [ADR 0011](../adr/0011-artifact-first-logbook.md), [artifact cutover](../reference/artifact-first-logbook-cutover.md). Surface map: [Logbook and Workbench](logbook-and-workbench.md).
...
- `docs/internal/CONTEXT.md` — ubiquitous language (artifact-first).
...
- Read `docs/internal/design.md` before visual work; read `docs/internal/CONTEXT.md` + ADR 0011 before Logbook/Workbench product work.
