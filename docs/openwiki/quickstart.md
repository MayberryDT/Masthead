...
- **Logbook** is a collection of **Pages**: capsule list + body inspector + provenance. Capsules remain artifacts internally. Always-visible Page checkboxes and filtered **Select all** feed optional Masthead Pages batch review; the compact **Publish** button is disabled until a Page is selected. There is no bulk enrich or session-library chrome.
